...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '0533b87a-0105-11f1-bfa5-0bcad6d1936c:1-658';
...
INSERT INTO `DopServicesApartment` VALUES (1,'Изъятие вещей и предметов из шкафов ',990,'Basic','AllRoom',''),(3,'Аккуратная укладка вещей ',490,'Basic','AllRoom',''),(4,'Замена постельного белья',490,'Basic','AllRoom',''),(5,'Протрем корпусную мебель внутри (пустые шкафы и тумбы) ',990,'Basic','AllRoom',''),(6,'Моем посуду',490,'Basic','Food',''),(7,'Помоем кухонные шкафы внутри (освобожденные от посуды) ',990,'Basic','Food',NULL),(8,'Помоем кухонные шкафы внутри (с изъятием всех принадлежностей) ',1290,'Basic','Food',''),(9,'Помоем микроволновую печь (свч) внутри',990,'Basic','Food',NULL),(10,'Помоем духовой шкаф внутри',990,'Basic','Food',''),(11,'Помоем холодильник внутри',990,'Basic','Food',NULL),(12,'Помоем вытяжку ',490,'Basic','Food',''),(13,'Собираем и выносим мусор, меняем мешки',490,'Basic','Food',''),(14,'Помоем стиральную машину внутри (отсек для порошка, резинку барабана) ',990,'Basic','WC',''),(15,'Аккуратная укладка вещей ',490,'General','AllRoom',''),(16,'Изъятие вещей и предметов из шкафов',990,'General','AllRoom',''),(17,'Помоем кухонные шкафы внутри (освобожденные от посуды)',990,'General','Food',''),(18,'Изъятие вещей и предметов из шкафов',990,'Repair','AllRoom',''),(19,'Замена постельного белья ',490,'General','AllRoom',''),(20,'Протирка корпусной мебели внутри (пустые шкафы и тумбы)',990,'General','AllRoom',''),(21,'Аккуратная укладка вещей ',490,'Repair','AllRoom',''),(22,'Замена постельного белья ',490,'Repair','AllRoom',''),(23,'Протирка корпусной мебели внутри (пустые шкафы и тумбы) ',990,'Repair','AllRoom',''),(24,'Очистка межплиточных швов ',990,'Basic','WC',''),(25,'Вынос малогабаритного строительного мусора (коробки, плёнка, мешки с мусором, мелкие остатки материалов)',2990,'Repair','AllRoom','');
...
INSERT INTO `DopServicesOffices` VALUES (1,'Генеральная уборка офиса (с перемещением мебели)',150,'м²'),(2,'Очистка после ремонта',170,'м²'),(4,'Чистка жалюзи',490,'окно');
...
INSERT INTO `DopServicesWindows` VALUES (1,'Высотная мойка (лестница/штанга)',490,'створка'),(2,'Мойка балконного блока',1190,''),(3,'Раздвижные конструкции, панорамные окна',590,'элемент'),(4,'Мойка зеркал, стеклянных столов, фасадов',290,'элемент'),(5,'Очистка от клейкой ленты, скотча, налета',490,'элемент'),(6,'Удаление строительных загрязнений',NULL,'от степени');
...
INSERT INTO `users` VALUES (1,'Администратор','Administrator','$2b$10$tCvooOroc0Z3BM7wTbRq5ur8YAzvXy6ruLI6EpOnHCEmyLkCqbpxK');
...
-- Dump completed on 2026-03-01 13:45:25
