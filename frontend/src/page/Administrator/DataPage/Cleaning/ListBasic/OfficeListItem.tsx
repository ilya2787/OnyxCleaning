...
const OfficeListItem: FC<Props> = ({ id, Text }) => {
	...
	return (
		<div className='OfficeListItem_itemStrong'>
			{!Edit ? (
				<p>{Text}</p>
			) : (
				<input
			...
			<div className='OfficeListItem_itemStrong--button'>
				{!Edit && (
					<button
						className='OfficeListItem_itemStrong--button--edit'
				...
				{Edit && (
					<>
						...
						<button
							className='OfficeListItem_itemStrong--button--delete'
							onClick={() => {
								if (
									window.confirm(
