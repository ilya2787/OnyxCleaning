...
const ApartmentListItem: FC<Props> = ({ id, Text }) => {
	...
	return (
		<div className='ApartmentCleaningItem_itemStrong'>
			{!Edit ? (
				<p>{Text}</p>
			) : (
				<input
			...
			<div className='ApartmentCleaningItem_itemStrong--button'>
				{!Edit && (
					<button
						className='ApartmentCleaningItem_itemStrong--button--edit'
				...
				{Edit && (
					<>
						...
						<button
							className='ApartmentCleaningItem_itemStrong--button--delete'
							onClick={() => {
								if (
									window.confirm(
